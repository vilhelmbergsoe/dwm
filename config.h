...
static const char *fonts[]          = { "monospace:pixelsize=28" };
static const char dmenufont[]       = "monospace:pixelsize=28";
...
static const char *cmdbrightnessdown[]  = { "brightnessctl", "s", "5%-", NULL };
